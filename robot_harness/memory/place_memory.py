"""In-memory PlaceMemory stub — stores place/location records."""
...
class InMemoryPlaceMemory:
    """Dict-backed in-process place memory stub."""

    # TODO (ADR-020): replace with an adapter to an external SpatialMemory server.
